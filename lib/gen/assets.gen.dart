...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/onboarding-image.png
  AssetGenImage get onboardingImage =>
      const AssetGenImage('assets/images/onboarding-image.png');
...
class $AssetsImagesIconsGen {
  ...
  SvgGenImage get chevronDown =>
      const SvgGenImage('assets/images/icons/chevron-down.svg');

  /// File path: assets/images/icons/close.svg
  SvgGenImage get close => const SvgGenImage('assets/images/icons/close.svg');

  /// File path: assets/images/icons/email.svg
  SvgGenImage get email => const SvgGenImage('assets/images/icons/email.svg');

  /// File path: assets/images/icons/google.svg
  SvgGenImage get google => const SvgGenImage('assets/images/icons/google.svg');

  /// File path: assets/images/icons/line.svg
  SvgGenImage get line => const SvgGenImage('assets/images/icons/line.svg');
